...
StageBack *Back_Christmas_New(void)
{
	...
	IO_Data arc_back = IO_Read("\\BG2\\CHRISTMS.ARC;1");
	Gfx_LoadTex(&this->tex_back0, Archive_Find(arc_back, "back0.tim"), 0);
	Gfx_LoadTex(&this->tex_back1, Archive_Find(arc_back, "back1.tim"), 0);
	Mem_Free(arc_back);
	
	//Load people textures
	this->arc_people = IO_Read("\\BG2\\PEOPLE.ARC;1");
	...
	this->arc_person = IO_Read("\\BG2\\PERSON.ARC;1");
	this->arc_person_ptr[0] = Archive_Find(this->arc_person, "person.tim");
	
	//Load fire textures
	this->arc_fire = IO_Read("\\BG2\\FIRE.ARC;1");
