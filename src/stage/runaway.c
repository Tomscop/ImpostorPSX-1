...
void Back_RunAway_DrawBG(StageBack *back)
{
	...
	RECT frontcloud1_src = {  0,  0, 64, 42};
	RECT_FIXED frontcloud1_dst = {FIXED_DEC(frontcloud+2,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud12_src = {  0+64,  0, 64, 42};
	RECT_FIXED frontcloud12_dst = {FIXED_DEC(frontcloud+2+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud2_src = {127,  0, 64, 42};
	RECT_FIXED frontcloud2_dst = {FIXED_DEC(frontcloud+500,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud22_src = {127+64,  0, 64, 42};
	RECT_FIXED frontcloud22_dst = {FIXED_DEC(frontcloud+500+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud3_src = {  0, 43, 64, 42};
	RECT_FIXED frontcloud3_dst = {FIXED_DEC(frontcloud+998,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud32_src = {  0+64, 43, 64, 42};
	RECT_FIXED frontcloud32_dst = {FIXED_DEC(frontcloud+998+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud4_src = {127, 43, 64, 42};
	RECT_FIXED frontcloud4_dst = {FIXED_DEC(frontcloud+1496,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud42_src = {127+64, 43, 64, 42};
	RECT_FIXED frontcloud42_dst = {FIXED_DEC(frontcloud+1496+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud5_src = {  0,  0, 64, 42};
	RECT_FIXED frontcloud5_dst = {FIXED_DEC(frontcloud+1998,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud52_src = {  0+64,  0, 64, 42};
	RECT_FIXED frontcloud52_dst = {FIXED_DEC(frontcloud+1998+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud6_src = {127,  0, 64, 42};
	RECT_FIXED frontcloud6_dst = {FIXED_DEC(frontcloud+2496,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud62_src = {127+64,  0, 64, 42};
	RECT_FIXED frontcloud62_dst = {FIXED_DEC(frontcloud+2496+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud7_src = {  0, 43, 64, 42};
	RECT_FIXED frontcloud7_dst = {FIXED_DEC(frontcloud+2994,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	RECT frontcloud72_src = {  0+64, 43, 64, 42};
	RECT_FIXED frontcloud72_dst = {FIXED_DEC(frontcloud+2994+251,1) - fx, FIXED_DEC(331,1) - fy, FIXED_DEC(251,1), FIXED_DEC(163,1)};
	Stage_DrawTex(&this->tex_back4, &frontcloud1_src, &frontcloud1_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud12_src, &frontcloud12_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud2_src, &frontcloud2_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud22_src, &frontcloud22_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud3_src, &frontcloud3_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud32_src, &frontcloud32_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud4_src, &frontcloud4_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud42_src, &frontcloud42_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud5_src, &frontcloud5_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud52_src, &frontcloud52_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud6_src, &frontcloud6_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud62_src, &frontcloud62_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud7_src, &frontcloud7_dst, stage.camera.bzoom);
	Stage_DrawTex(&this->tex_back4, &frontcloud72_src, &frontcloud72_dst, stage.camera.bzoom);
