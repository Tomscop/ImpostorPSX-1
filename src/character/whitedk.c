...
static const CharFrame char_whitedk_frame[] = {
  ...
  {WhiteDK_ArcMain_Left0, {  0,101,133,101}, {253,137}}, //6 left 2
  ...
  {WhiteDK_ArcMain_Down1, {  0, 98,141, 98}, {263,126}}, //12 down 4

  {WhiteDK_ArcMain_Up0, {  0,  0,137,109}, {259,147}}, //13 up 1
  {WhiteDK_ArcMain_Up0, {  0,112,143,112}, {264,150}}, //14 up 2
  ...
  {WhiteDK_ArcMain_Right1, {  0,105,138,105}, {253,142}}, //20 right 4
};
...
Character *Char_WhiteDK_New(fixed_t x, fixed_t y)
{
	...
	//Load art
	this->arc_main = IO_Read("\\CHAR\\WHITEDK.ARC;1");
